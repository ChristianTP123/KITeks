      ...
      <div id="top" className='grid h-fit  gap-1'>
        ...
        <div className=''>
          <div className='col-span-1'>
            <div className=' absolute left-5 top-20 bg-primary bottom-2 h-[200%] w-0.5 z-10'></div>
          ...
          <div className='col-span-3 text-center text-white flex flex-col justify-center'>
            ...
            <div className='grid grid-cols-7 text-left'>
              ...
              <label>
              <input type="checkbox" class="form-checkbox h-[10%] w-[10%] text-primary bg-main transition duration-150 ease-in-out mr-2 mb-2" onClick={() => setShowPassword(!showPassword)}/>
              </label>
            </div>
          </div>
